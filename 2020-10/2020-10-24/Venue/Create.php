...
<!-- Title -->
<?= $this->section('title') ?>Create Venue<?= $this->endSection() ?>
...
<div class="row">
  <div class="col-xl-12">
    <section class="hk-sec-wrapper">
      ...
      <div class="row">
        <div class="col-xl-12">
          <form action="<?= route_to('venue-create') ?>" method="POST" accept-charset="utf-8" autocomplete="off" spellcheck="false" enctype="multipart/form-data">
            <?= csrf_field() ?>
            <!-- Venue name -->
            <div class="form-group row">
              ...
              <div class="col-md-9">
                <input type="text" class="form-control <?= session('errors.name') ? "is-invalid" : null ?>" id="name" value="<?= old('name') ?>" name="name" minlength="3" maxlength="255" pattern="<?= NAME_EXP ?>" required>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-9">
                <input type="text" class="form-control <?= session('errors.authority') ? "is-invalid" : null ?>" id="authority" value="<?= old('authority') ?>" name="authority" required minlength="3" maxlength="255" pattern="<?= NAME_EXP ?>">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-9">
                <input type="text" class="form-control <?= session('errors.office_key') ? "is-invalid" : null ?>" id="office_key" value="<?= old('office_key') ?>" name="office_key" required minlength="3" maxlength="255" pattern="<?= NAME_EXP ?>">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-9">
                <input type="text" class="form-control <?= session('errors.contact') ? "is-invalid" : null ?>" id="contact" value="<?= old('contact') ?>" name="contact" required min="11" max="11" pattern="<?= MOBILE_EXP ?>">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <textarea class="form-control <?= session('errors.body') ? "is-invalid" : null ?>" id="body" name="body" rows="3"><?= old('body') ?></textarea>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-7">
                  <input type="number" class="form-control <?= session('errors.number_of_halls') ? "is-invalid" : null ?>" id="numHB" value="<?= old('number_of_halls', 1) ?>" name="number_of_halls" min="1" max="99" required>
                  <div class="error"> <?= session('error.number_of_halls') ?></div>
                </div>
                <div class="col-md-2">
                  <button type="button" id="createBlock" class="btn btn-primary btn-block">Generate</button>
                </div>
              </div>
