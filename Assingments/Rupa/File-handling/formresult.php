	...
	if (isset($_POST["btn"]))/*Output for search button */
	 {
		...
		$s = fopen("$search.txt", "r") or die("File doesn't exist"); /* Opened the file of searched id if exist,otherwise show the given message*/ 
		echo fread($s, filesize("$search.txt")); /* Read the information of the file and show to the user */
